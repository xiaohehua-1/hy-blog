...
const statList = ref([
  { label: '文章', value: 0, icon: markRaw(Document), color: 'icon-blue' },
  { label: '标签', value: 0, icon: markRaw(PriceTag), color: 'icon-green' },
  { label: '分类', value: 0, icon: markRaw(Folder), color: 'icon-yellow' },
  { label: '评论', value: 0, icon: markRaw(ChatDotRound), color: 'icon-red' },
  { label: '留言', value: 0, icon: markRaw(Message), color: 'icon-purple' },
